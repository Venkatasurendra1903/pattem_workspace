...
public class UberBookingSteps {
	...
	public void user_selects_car_and_pick_up_point_and_drop_location(String carType, String picUpLocation, String dropLocation) {
		System.out.println("Step 2: "+carType+" "+picUpLocation+" "+dropLocation);
